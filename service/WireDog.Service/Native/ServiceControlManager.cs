...
namespace WireDog.Service.Native;

/// <summary>
/// Windows Service Control Manager (SCM) P/Invoke definitions
/// Based on official WireGuard example Win32.cs
/// </summary>
public static class ServiceControlManager
{
    ...
    [return: MarshalAs(UnmanagedType.Bool)]
    public static extern bool ChangeServiceConfig2(IntPtr hService, ServiceConfigType dwInfoLevel, ref ServiceSidInfo lpInfo);
